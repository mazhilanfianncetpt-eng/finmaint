  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-4 md:px-6 flex flex-col gap-4 -mt-10 pb-6 relative z-10">
        ...
        >
          <p className="text-[10px] uppercase tracking-wider font-semibold mb-3" style={{ color: 'var(--color-muted)' }}>
            All-time report
          </p>
          <div className="metric-grid">
            ...
            <MetricTile label="Yet to Receive"    value={inr(totalYetToReceive)}    variant="closing-bad" />
        ...
        <section aria-label="Search borrowers">
          ...
          <div className="relative">
            ...
            />
            {search && (
              <button onClick={() => { setSearch(''); setSelectedBId(null) }} className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--color-muted)' }} aria-label="Clear search">
                <X size={14} />
              </button>
            )}
          </div>
        ...
        >
          ...
          <div className="flex gap-2" role="status" aria-live="polite">
            <div className="flex-1 text-center py-2 rounded-xl text-sm font-medium" style={{ backgroundColor: 'rgba(16,185,129,0.12)', color: 'var(--color-primary-500)' }}>
              ✓ Paid <span className="font-bold">{paidToday}</span>
            </div>
            <div className="flex-1 text-center py-2 rounded-xl text-sm font-medium" style={{ backgroundColor: 'rgba(239,68,68,0.08)', color: 'var(--color-danger-400)' }}>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-1 text-xs mb-3">
        ...
        {overdue > 0 && (
          <div><span style={{ color: 'var(--color-danger-400)' }}>{overdue} overdue</span></div>
        )}
      </div>
